...
# Manually set arguments for testing
args = {
    "prototxt": "path/to/MobileNetSSD_deploy.prototxt.txt",
...
prototxt_path = "/Users/vamshi/Downloads/Real-Time-Object-Detection-With-OpenCV-master/MobileNetSSD_deploy.prototxt.txt"
model_path = "/Users/vamshi/Downloads/Real-Time-Object-Detection-With-OpenCV-master/MobileNetSSD_deploy.caffemodel"

try:
    # Test if the prototxt file can be opened
    with open(prototxt_path, 'r') as f:
        print("Successfully accessed prototxt.")
except IOError:
    print("Failed to access prototxt at:", prototxt_path)

try:
    # Test if the model file can be opened
    with open(model_path, 'rb') as f:
        print("Successfully accessed model.")
except IOError:
    print("Failed to access model at:", model_path)

# If successful, proceed to load the model with OpenCV
